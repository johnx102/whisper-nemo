...
# ÉTAPE 6.5: FIX huggingface_hub AVANT NeMo
...
# ÉTAPE 8: Installation NeMo (exactement comme avant mais avec huggingface_hub fixé)
RUN echo "Attempting NeMo installation..." && \
    ...
    echo "❌ NeMo installation failed - will use basic diarization"
